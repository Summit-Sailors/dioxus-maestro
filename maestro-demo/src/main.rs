...
use maestro_demo::{components::maestro_themes::theme::prelude::ThemeProvider, router::Route};
...
fn main() {
	...
	dioxus::LaunchBuilder::new()
		...
		.with_context(server_only!(
			maestro_apalis::create::create_apalis_storage_sync::<maestro_demo::clients::utilities::EmailJob>().db_url(std::env!("APALIS_DATABASE_URL")).call()
		))
