      ...
      match *active_section.read() {
          HookSection::Clipboard => rsx! {
            section { class: "clipboard-demo bg-gray-900 p-6 rounded-lg shadow",
              ...
              input {
                class: "w-4/5 mx-auto sm:w-full bg-gray-900 border border-gray-500 text-gray-100 rounded px-3 py-2 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none placeholder-gray-500",
          ...
          HookSection::Pagination => rsx! {
            section { class: "pagination-demo bg-gray-900 p-6 rounded-lg shadow",
              ...
              table { class: "w-auto mx-auto text-center border-collapse shadow border border-gray-500 rounded-lg mb-6",
                tr {
                ...
                tr {
                  ...
                  td { class: "border px-4 py-2 text-yellow-500 font-bold",
                ...
                tr {
                  td { class: "border px-4 py-2 text-gray-200", "Pagination Status: " }
                  td { class: "border px-4 py-2 text-gray-200",
              ...
              div { class: "grid grid-cols-3 gap-2",
                {
                    ...
                    items
                        ...
                        .map(|item| {
                            rsx! {
                              div {
                                class: "border border-gray-600 rounded-md p-2 text-gray-200 bg-gray-400 shadow-sm text-center",
                                key: "{item}",
                                "Item {item}"
                              }
                            }
