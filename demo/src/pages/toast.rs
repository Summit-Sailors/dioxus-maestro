use {
  crate::components::ui::features::Features, dioxus::prelude::*, maestro_toast::{
    ctx::use_toast, 
...
pub fn ToastDemo() -> Element {
  ...
  rsx! {
    div {
      class: "grid flex justify-center bg-gray-900 rounded-lg shadow-md p-4 w-full",
      div { class: "mb-8",
				h1 { class: "text-gray-100 text-center text-3xl font-bold mb-2", "Maestro Toast" }
      ...
      div {
        class: "grid flex grid-cols-1 justify-center items-center md:grid-cols-3 gap-4 mb-6",
        button {
