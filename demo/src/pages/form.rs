...
pub fn FormsDemo() -> Element {
  ...
  rsx! {
    div {
      class: "max-w-4xl mx-auto p-6 bg-white text-gray-100 rounded-lg shadow-lg",
      div {
        class: "mb-8",
        h1 {
          class: "text-gray-800 text-center text-3xl font-bold mb-2",
          "Maestro Forms Demo"
        }
        p {
        ...
        div {
          class: "grid justify-center grid-cols-2 mt-4 space-x-2 flex",
          button {
            class: "{async_class}",
