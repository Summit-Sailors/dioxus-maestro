...
pub fn UIDemo() -> Element {
    ...
    div { class: "mx-auto p-4 bg-gray-900 rounded-lg shadow-lg",
      ...
      ComponentSection {
        ...
        div { class: "grid grid-cols-1 md:grid-cols-3 gap-6 w-4/5 mx-auto sm:w-full",
          Button {
            r#type: "button",
      ...
      ComponentSection {
        ...
        div { class: "space-y-4 text-left w-4/5 mx-auto sm:w-full",
          Label {
      ...
      ComponentSection {
        ...
        div { class: "space-y-6 text-left w-4/5 mx-auto sm:w-full",
          Select {
            options: vec![
                SelectOption {
      ...
      ComponentSection {
        ...
        div { class: "space-y-6 w-4/5 mx-auto sm:w-full flex justify-center",
          div { class: "space-y-4",
            ToggleSwitch {
              state: toggle_state,
          ...
          div { class: "flex space-y-6",
            div { class: "items-center gap-2 text-gray-300",
              Radio {
