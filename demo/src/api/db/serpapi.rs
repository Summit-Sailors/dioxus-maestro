use {
  dioxus::prelude::*,
  maestro_serpapi::{client::serpapi_request, request_type::{ETimeFrame, Engine, SafeSearch, SearchType}, 
...
fn SerpApiDemo() -> Element {
  let state = use_signal(|| SearchState {
    query: String::new(),
    results: Vec::new(),
    loading: false,
    error: None,
    ...
    div {
      ...
      form {
        ...
        button {
          ...
          if state.loading { "Searching..." } else { "Search" }
        }
      }
