...
pub fn ParallelQueriesDemo() -> Element {
  ...
  rsx! {
    div {
      class: "flex flex-col items-center justify-center rounded-lg shadow-lg p-6 bg-gray-100",
      
      div {
        class: "w-full max-w-4xl bg-white rounded-lg shadow-lg p-6",
        
        h3 {
          class: "text-2xl text-gray-700 text-center font-bold mb-6",
          "Parallel Queries Demo"
        }
