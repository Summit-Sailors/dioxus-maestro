...
pub fn CodeEditor(props: CodeEditorProps) -> Element {
    ...
    div { class: "dark p-2 bg-gray-800 rounded-lg h-full w-full flex flex-col",
      ...
      div {
        ...
        div { class: "bg-gray-300 overflow-hidden dark:bg-gray-700 rounded-lg shadow-md border border-gray-800 dark:border-gray-500 mt-4 flex-1",
