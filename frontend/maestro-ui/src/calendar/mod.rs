		...
		CalendarMaybeWrapper { is_full, selected_date, wrapper_class,
			div {
				...
				div { class: tw_merge!("p-4 maestro-calendar-body", body_class),
					div { class: tw_merge!("grid !md:grid-cols-7 gap-2 mb-2 maestro-calendar-days", days_class),
					...
					div { class: tw_merge!("grid !md:grid-cols-7 gap-2 maestro-calendar-grid", grid_class),
						if empty_cells < 6 {
