use {
	...
	maestro_ui::{
		...
		sheet::{Sheet, SheetBody, SheetClose, SheetContent, SheetDescription, SheetFooter, SheetHeader, SheetTitle, SheetTrigger},
	},
};
...
#[component]
pub fn SheetStyledPage() -> Element {
	rsx! {
		DescriptionSection {
			...
			div { class: "grow flex flex-col justify-center items-center rounded-md border border-neutral-800 bg-neutral-950 overflow-hidden",
				div { class: "p-6 flex grow items-center justify-center w-full",
					Sheet { default_open: false,
						...
						SheetContent { side: ESide::Bottom,
							SheetHeader {
								SheetTitle { "Uncontrolled dialog" }
								SheetDescription { "But it may be controlled too" }
							}
		...
		DescriptionSection { title: "Api Reference",
			div { class: "flex flex-col space-y-6",
				div { class: "flex flex-col gap-4",
					h4 { class: "font-medium text-lg text-orange-300", "SheetRoot" }
					p {
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetOverlay" }
					p {
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetTrigger" }
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetContent" }
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetHeader" }
					p { class: "mb-4",
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetTitle" }
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetDescription" }
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetBody" }
					p { class: "mb-4",
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetFooter" }
					p { class: "mb-4",
				...
				div {
					h4 { class: "font-medium text-lg text-orange-300", "SheetClose" }
