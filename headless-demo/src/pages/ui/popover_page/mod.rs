...
#[component]
pub fn PopoverStyledPage() -> Element {
					...
					Popover { class: "w-fit",
						...
						PopoverContent {
							...
							div { class: "flex flex-col gap-4",
								...
								if show_nested() {
									Popover { class: "w-fit mx-auto ",
										PopoverTrigger { class: "mx-auto px-3", "Nested Popover" }
										PopoverContent {
											side: ESide::Top,
											side_offset: 4.0,
